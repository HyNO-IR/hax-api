...
var temp = path.join(tmpdir(), `${Crypto.randomBytes(6).readUIntLE(0,6).toString(36)}`)
...
loghandler = {
    ...
    error: {
        status: false,
        creator: `${creator}`,
        message: 'Error Hubungi Gwehj wa.me/62895330026617'
    }
}
...
const listkey = ["hax", "ulhaqmz", "UlhaqMz", "dindacantik"];
...
//tools
router.get('/other/ssweb-hp', async(req, res, next) => {
...
router.get('/other/ssweb-pc', async(req, res, next) => {
  const text = req.query.text;
  const apikey = req.query.apikey;
...
router.get('/maker/gay', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/glass', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/comrade', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/grayscale', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/invertgrayscale', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/brightnes', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/threshold', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/sepia', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/red', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/green', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/bloo', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/blurple', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/delete', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/blurple2', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/creator/yt-comment', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
...
router.get('/creator/tweet', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
...
router.get('/maker/stupid', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
...
router.get('/maker/simpcard', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/horny', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/lolice', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/lgbt', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/pansexual', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/nonbinary', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/lesbian', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/bisexual', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/maker/transs', async(req, res, next) => {
  const apikey = req.query.apikey;
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/creator/gura', async (req, res) => {
          const apikey = req.query.apikey;
  const nama = req.query.nama;
  if(!nama) return res.json(loghandler.notnama)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/creator/gfx1', async (req, res) => {
            const apikey = req.query.apikey;
  const nama = req.query.nama;
  if(!nama) return res.json(loghandler.notnama)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/creator/gfx2', async (req, res) => {
            const apikey = req.query.apikey;
  const nama = req.query.nama;
  if(!nama) return res.json(loghandler.notnama)
  if(!apikey) return res.json(loghandler.notparam)
...
router.get('/creator/gfx3', async (req, res) => {
     const apikey = req.query.apikey;
  const text = req.query.text;
  const text2 = req.query.text2;
  if(!text) return res.json(loghandler.nottext)
...
router.get('/creator/gfx4', async (req, res) => {
     const apikey = req.query.apikey;
  const text = req.query.text;
  const text2 = req.query.text2;
  if(!text) return res.json(loghandler.nottext)
...
router.get('/creator/welcome2', async (req, res) => {
            const apikey = req.query.apikey;
...
const Welcome = await new ch.Welcome2()
.setAvatar(pp)
.setUsername(nama)
.setBg(bg)
.setGroupname(namagc)
...
router.get('/creator/goodbye2', async (req, res) => {
            const apikey = req.query.apikey;
          const pp = req.query.pp;
           const nama = req.query.nama;
           const bg = req.query.bg;  
...
const Goodbye = await new ch.Goodbye2()
.setAvatar(pp)
.setUsername(nama)
.setBg(bg)
.setMember(member)
...
router.get('/creator/verivikasi', async(req, res, next) => {
const apikey = req.query.apikey;
  const nama = req.query.nama;
  const namaGb = req.query.namaGb;
  const pepeGb = req.query.pepeGb;
...
router.get('/cecan/vietnam', async (req, res, next) => {
  ...
  const Viet = JSON.parse(fs.readFileSync(__path +'/data/vietnam.json'));
  const randViet = Viet[Math.floor(Math.random() * Viet.length)];
  data = await fetch(randViet).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/vietnam.jpeg', data)
  res.sendFile(__path +'/tmp/vietnam.jpeg')
} else {
res.json(loghandler.invalidKey)
}
})
router.get('/cecan/china', async (req, res, next) => {
  ...
  const China = JSON.parse(fs.readFileSync(__path +'/data/china.json'));
  const randChina = China[Math.floor(Math.random() * China.length)];
  data = await fetch(randChina).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/china.jpeg', data)
  res.sendFile(__path +'/tmp/china.jpeg')
} else {
res.json(loghandler.invalidKey)
}
})
router.get('/cecan/japan', async (req, res, next) => {
  ...
  const Japan = JSON.parse(fs.readFileSync(__path +'/data/japan.json'));
  const randJapan = Japan[Math.floor(Math.random() * Japan.length)];
  data = await fetch(randJapan).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/japan.jpeg', data)
  res.sendFile(__path +'/tmp/japan.jpeg')
} else {
res.json(loghandler.invalidKey)
}
})
router.get('/cecan/korea', async (req, res, next) => {
  ...
  const Korea = JSON.parse(fs.readFileSync(__path +'/data/korea.json'));
  const randKorea = Korea[Math.floor(Math.random() * Korea.length)];
  data = await fetch(randKorea).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/korea.jpeg', data)
  res.sendFile(__path +'/tmp/korea.jpeg')
} else {
res.json(loghandler.invalidKey)
}
})
router.get('/cecan/thailand', async (req, res, next) => {
  ...
  const Thai = JSON.parse(fs.readFileSync(__path +'/data/thailand.json'));
  const randThai = Thai[Math.floor(Math.random() * Thai.length)];
  data = await fetch(randThai).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/thailand.jpeg', data)
  res.sendFile(__path +'/tmp/thailand.jpeg')
} else {
res.json(loghandler.invalidKey)
}
})
router.get('/cecan/justinaxie', async (req, res, next) => {
        var Apikey = req.query.apikey
            
	if(!Apikey) return res.json(loghandler.notparam)
	if(listkey.includes(Apikey)){

  const Just = JSON.parse(fs.readFileSync(__path +'/data/justinaxie.json'));
  const randJust = Just[Math.floor(Math.random() * Just.length)];
  data = await fetch(randJust).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/justinaxie.jpeg', data)
  res.sendFile(__path +'/tmp/justinaxie.jpeg')
} else {
res.json(loghandler.invalidKey)
}
})
router.get('/cecan/hijaber', async (req, res, next) => {
  ...
  const Hijab = JSON.parse(fs.readFileSync(__path +'/data/hijaber.json'));
  const randHijab = Hijab[Math.floor(Math.random() * Hijab.length)];
  data = await fetch(randHijab).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/hijaber.jpeg', data)
  res.sendFile(__path +'/tmp/hijaber.jpeg')
} else {
res.json(loghandler.invalidKey)
}
})
router.get('/cecan/indonesia', async (req, res, next) => {
  ...
  const Indo = JSON.parse(fs.readFileSync(__path +'/data/indonesia.json'));
  const randIndo = Indo[Math.floor(Math.random() * Indo.length)];
  data = await fetch(randIndo).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/indonesia.jpeg', data)
  res.sendFile(__path +'/tmp/indonesia.jpeg')
} else {
res.json(loghandler.invalidKey)
}
})
router.get('/cecan/malaysia', async (req, res, next) => {
  ...
  const Malay = JSON.parse(fs.readFileSync(__path +'/data/malaysia.json'));
  const randMalay = Malay[Math.floor(Math.random() * Malay.length)];
  data = await fetch(randMalay).then(v => v.buffer())
  await fs.writeFileSync(__path +'/tmp/malaysia.jpeg', data)
  res.sendFile(__path +'/tmp/malaysia.jpeg')
} else {
res.json(loghandler.invalidKey)
}
})
...
router.get('/news/cnn', async (req, res, next) => {
	...
	if(apikeyInput != 'ulhaqmz') return res.json(loghandler.invalidKey)
...
router.get('/game/tebakkabupaten', async (req, res, next) => {
    ...
    if(listkey.includes(Apikey)){
        var index = JSON.parse(
            fs.readFileSync(__path + '/data/tebakkabupaten.json')
        )
        res
          .status(200)
          .json({
              code: 200,
              success: true,
              ...index[~~(Math.random() * index.length)]
          })
    } else {
        res.json(loghandler.invalidKey)
    }
...
router.get('/stalk/ig9', async (req, res, next) => {
          var apikey = req.query.apikey
          var url = req.query.username
       	if(!apikey) return res.sendFile(__path + '/views/apikey.html')
       if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter username"})
...
router.get('/stalk/repostalk', async (req, res, next) => {
          var apikey = req.query.apikey
       	var text = req.query.repo
       	if(!apikey) return res.sendFile(__path + '/docs/403.html')
       if(!text) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter repo"})
        if(listkey.includes(apikey)){
...
router.get('/download/shoppe', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.zeks.me/api/shopee?apikey=apivinz&q=${q}`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/random/nyindir', async (req, res, next) => {
        var apikey = req.query.apikey
...
router.get('/random/cersex', async(req, res, next) => {
  Apikey = req.query.apikey;
  if(!Apikey) return res.json(loghandler.notparam)
  if(listkey.includes(Apikey)) {
    fetch(encodeURI(`https://leyscoders-api.herokuapp.com/api/cersex?apikey=dappakntlll`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/randomquotes', async (req, res, next) => {
        var apikeyInput = req.query.apikey
...
router.get('/random/quotesmuslim', async (req, res, next) => {
        var apikeyInput = req.query.apikey
...
router.get('/info/cuacabandara', async (req, res, next) => {
        var apikeyInput = req.query.apikey
...
router.get('/info/cuacadunia', async (req, res, next) => {
        var apikeyInput = req.query.apikey
...
router.get('/info/tsunami', async (req, res, next) => {
        var apikeyInput = req.query.apikey
...
router.get('/fun/motivasi', async (req, res, next) => {
    ...
    if(!Apikey) return res.json(loghandler.notparam)
    if(listkey.includes(Apikey)){
        var motivasi = JSON.parse(
            fs.readFileSync(__path + '/data/motivasi.json')
        )
        res
          .status(200)
          .json({
              code: 200,
              success: true,
              ...motivasi[~~(Math.random() * motivasi.length)]
          })
    } else {
        res.json(loghandler.invalidKey)
    }
...
router.get('/textpro/p', async(req, res, next) => {
...
router.get('/textpro/a', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    zrapi 
  .ephoto("https://en.ephoto360.com/handwritten-text-on-foggy-glass-online-680.html", [
    text, 
  ])
  .then((data) => {
          var urlnya = data
...
router.get('/textpro/neon-online', async(req, res, next) => {
...
router.get('/textpro/neon-galaxy', async(req, res, next) => {
...
router.get('/textpro/neon-green', async(req, res, next) => {
...
router.get('/textpro/batman-logo', async(req, res, next) => {
...
router.get('/textpro/glitch3', async(req, res, next) => {
